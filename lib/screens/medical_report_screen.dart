...
class _MedicalReportScreenState extends State<MedicalReportScreen> {
  ...
  String _selectedEmergencyType = 'Malaise';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      _buildEmergencyTypeButton('Malaise', Icons.sick),
                      ...
                      _buildEmergencyTypeButton('Autre urgence', Icons.warning),
                    ],
                  ),
                  const SizedBox(height: 20),
                  const Text(
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: "Décrivez l'urgence médicale ici...",
  ...
  Widget _buildEmergencyTypeButton(String type, IconData icon) {
    final isSelected = _selectedEmergencyType == type;
    return Container(
      width: double.infinity,
      margin: const EdgeInsets.only(bottom: 15),
      child: OutlinedButton(
        onPressed: () => setState(() => _selectedEmergencyType = type),
  ...
  Widget _buildBottomNavBar(BuildContext context, int currentIndex) {
    // inchangé
    return Container(); // remplace ceci par ton code original
  }
  ...
  void _submitForm() {
    ...
    HistoryService().addHistoryItem(
      type: 'Urgence',
      description: '${_selectedEmergencyType}: ${_descriptionController.text}',
      location: _locationController.text,
    );

    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Rapport médical envoyé')));
